/**
 * @fileoverview Type definitions for Codex CLI AI SDK provider
 * These JSDoc types mirror the TypeScript interfaces from the original provider
 */

/**
 * Codex CLI provider settings
 * @typedef {Object} CodexCliSettings
 * @property {string} [pathToCodexCliExecutable='codex'] - Custom path to Codex CLI executable
 ...
 * @typedef {'opus'|'sonnet'|string} CodexCliModelId
 */

/**
 * Language model options
 * @typedef {Object} CodexCliLanguageModelOptions
 * @property {CodexCliModelId} id - The model ID
 * @property {CodexCliSettings} [settings] - Optional settings
 */

/**
 * Error metadata for Codex CLI errors
 * @typedef {Object} CodexCliErrorMetadata
...
/**
 * Codex CLI provider interface
 * @typedef {Object} CodexCliProvider
 * @property {function(CodexCliModelId, CodexCliSettings=): Object} languageModel - Create a language model
 * @property {function(CodexCliModelId, CodexCliSettings=): Object} chat - Alias for languageModel
 * @property {function(string): never} textEmbeddingModel - Throws NoSuchModelError (not supported)
 */

/**
 * Codex CLI provider settings
 * @typedef {Object} CodexCliProviderSettings
 * @property {CodexCliSettings} [defaultSettings] - Default settings to use for all models
 */
